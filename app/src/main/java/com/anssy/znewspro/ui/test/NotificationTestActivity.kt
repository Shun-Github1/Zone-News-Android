package com.anssy.znewspro.ui.test
...
import com.anssy.znewspro.databinding.ActivityNotificationTestBinding
import com.anssy.znewspro.utils.NotificationManager as AppNotificationManager
...
class NotificationTestActivity : BaseActivity() {
    ...
    private fun sendTestNotification(
        ...
        val intent = when (type) {
            "news" -> {
                android.content.Intent(this, com.anssy.znewspro.ui.MainActivity::class.java).apply {
    ...
    private fun sendNotificationWithAction() {
        ...
        // Main intent
        val mainIntent = android.content.Intent(this, com.anssy.znewspro.ui.MainActivity::class.java)
