...
public class SettingPopupWindow extends BasePopupWindow {
    public SettingPopupWindow(Context context) {
        ...
        setBackgroundColor(androidx.core.content.ContextCompat.getColor(context, R.color.transparent));
    }
    ...
    public void onViewCreated(View contentView) {
        ...
        contentView.findViewById(R.id.apply_btn).setOnClickListener(v -> {
            ...
            if (themeId == R.id.light_rb)
                themeMode = "light";
            else if (themeId == R.id.dark_rb)
                themeMode = "dark";
            ...
            if (iconId == R.id.alternate_icon_rb)
                iconType = "alternate";
