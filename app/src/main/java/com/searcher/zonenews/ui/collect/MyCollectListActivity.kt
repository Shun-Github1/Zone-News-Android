package com.searcher.zonenews.ui.collect
 ...
 * @Description 我的收藏
 * @Author yulu
 * @CreateTime 2025年07月04日 10:33:00
 */

class MyCollectListActivity:BaseActivity() {
    ...
    private fun initView() {
        ...
        mAdapter = object : CommonAdapter<ViewHisEntry.DataDTO.ArticlesDTO>(this, R.layout.item_brown_his,mList){
            override fun convert(holder: ViewHolder, t: ViewHisEntry.DataDTO.ArticlesDTO, position: Int) {
                ...
                Glide.with(mContext).load(t.pictureURL).error(R.drawable.ic_image_not_supported_24).into(newsIv)
