...
import com.searcher.zonenews.databinding.FragmentReadingHistoryBottomSheetBinding
...
class ReadingHistoryBottomSheetFragment : BottomSheetDialogFragment() {
    
    private var _binding: FragmentReadingHistoryBottomSheetBinding? = null
    ...
    companion object {
        fun newInstance(): ReadingHistoryBottomSheetFragment {
            return ReadingHistoryBottomSheetFragment()
        }
    }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentReadingHistoryBottomSheetBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupViewModel() {
        ...
        // Observe browsing history data
        myModel.myViewHisEntry.observe(viewLifecycleOwner) { response ->
            if (response != null) {
        ...
        viewHolder?.itemView?.let { itemView ->
            ...
            deleteButtonLayout.animate()
                ...
                .withEndAction {
                    ...
                    myModel.deleteHistory(articleId)
                }
                .start()
        } ?: run {
    ...
    private fun showClearAllConfirmation() {
        SystemDialogUtils.showAlertDialog(
            requireContext(),
            getString(R.string.clear_reading_history_confirmation_title),
            getString(R.string.clear_reading_history_confirmation_message),
            getString(R.string.clear_reading_history_confirmation_confirm),
