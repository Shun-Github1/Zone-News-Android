...
object ToastUtils {
    ...
    /**
     * Pre-initialize Toast to avoid first-call lag.
     * Call this during app startup (e.g., in Application.onCreate or MainActivity.onCreate)
     */
    @JvmStatic
    fun warmUp(context: Context) {
        try {
            getToast(context.applicationContext)
        } catch (e: Exception) {
